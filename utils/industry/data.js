export const products = [
  {
    id: 1,
    img: "/images/industry/Downpic.cc-1733213138.jpg",
    name: "Automotive",
    description:
    ...
    applications: [
      ...
      {
        title: "Laminating and testing of windshields",
        explain:
      ...
      {
        title: "Electric car battery production",
        explain:
    ...
    solutions: "Our solutions for the automotive industry",
    subApplications: [
      {
        name: "Oil-free air compressors",
        products: [
          {
            img: "/images/industry/compressori-d'aria-amici-dell'ambiente-atlas-copco.png",
            name: "Oil-free screw air compressors ZR & ZT (VSD)",
          },
          {
            img: "/images/industry/aq30vsdff-ghost-out.jpeg",
            name: "AQ water-injected oil-free screw compressors",
          },
          {
            img: "/images/industry/ZR+cam+0007.png",
            name: "Oil-free air compressors",
          },
        ],
      },
      {
        ...
        products: [
          {
            img: "/images/industry/k1925-01-atlas-copco-zb-turbogeblaese-installation-20x30.jpeg",
            name: "Oil-free turbo blowers ZB VSD⁺",
          },
          {
            img: "/images/industry/63_ZS_SETUP+-+cam+portrait+001.png",
            name: "Oil-free blowers for low pressure applications",
          },
        ],
      },
      {
        name: "Oil-lubricated air compressors",
        products: [
          {
            img: "/images/industry/screw-compressor-ga55-ga90.jpeg",
            name: "Oil-lubricated screw compressors GA (VSD⁺)",
          },
          {
            img: "/images/industry/g18ff-ghost-r-in-2021.png",
            name: "Oil-lubricated screw compressor G (VSD)",
          },
        ],
      },
      {
        name: "Filters and Dryers",
        products: [
          {
            img: "/images/industry/dd145plus-pack.jpeg",
            name: "Dust filtration for your air compressor",
          },
          {
            img: "/images/industry/mdg-1050.png",
            name: "Rotary drum dryers MDG, MD & ND",
          },
        ],
      },
      {
        ...
        products: [
          {
            img: "/images/industry/ngp20plus-ghost-r-out.jpeg",
            name: "NGP⁺ 8-2800 premium N₂ generator with PSA",
          },
          {
            img: "/images/industry/ngp25-pack-r-2021-1600x1600.png",
            name: "NGP 10-115 PSA nitrogen generator",
          },
        ],
      },
    ],
  ...
  {
    id: 2,
    img: "/images/industry/Downpic.cc-582256640.jpg",
    name: "Chemical and Petrochemical",
    description:
      "Find out how we serve the complex requirements of the chemical & petrochemical industry.",
    applications: [
      {
        title: "Refineries MTBE, FCC",
      },
      {
        title: "Fertilizer Ammonia, Urea, Nitric Acid",
      },
      {
        title: "Gas to Liquid GTL",
      },
      {
        title: "Coal to Liquid CTL",
      },
      {
        title: "Coal to Methanol CTM",
      },
      {
        title: "Gas Aromatics PTA, Phenol, Caprolactam, Maleic Andrehyde",
      },
      {
        title: "Syngas Hydrogen, CO",
      },
      {
        title: "Ethylene / Propylene",
      },
      {
        title: "Polyethylene / Polypropylene",
      },
      {
        title: "Propane Dehydrogenation",
      },
      {
        title: "Butane Dehydrogenation",
      },
      {
        title: "Ethane Cracking",
      },
      {
        title: "Mechanical Vapor Recovery",
      },
    ],
    solutions: "Serving the chemical & petrochemical industry",
    subApplications: [
      {
        name: "Products for the chemical and petrochemical industry",
        products: [
          {
            name: "Oil-free air centrifugal compressor ZH and ZH+",
            img: "/images/industry/zhcomp.jpeg",
          },
          {
            name: "Oil-free screw air compressors ZR & ZT (VSD)",
            img: "/images/industry/compressori-d'aria-amici-dell'ambiente-atlas-copco.png",
          ...
          {
            name: "Reciprocating gas compressors HX & HN",
            img: "/images/industry/hxhn.png",
          },
          {
            name: "CU gas compressors",
            img: "/images/industry/cu-compressor-1600x1600px.jpeg",
          },
          {
            name: "ZHL single-stage centrifugal compressors",
            img: "/images/industry/2021-0830-vintage-ac360-zhl8-sideview-01.png",
          },
        ],
      },
    ],
  ...
  {
    id: 3,
    img: "/images/industry/Downpic.cc-1477067152.jpg",
    name: "Electric car battery production",
    description:
      "Complete compressed air and gas equipment for sustainably produced batteries for electrical cars at the lowest possible production cost.",
    applications: [
      {
        title: "Lithium-ion batteries for electric cars",
        explain:
      ...
      {
        title: "Optimal compressor load distribution",
        explain:
          "Large compressor networks, similar to orchestras, do need a conductor to make all equipment work together most efficiently. The central controller Optimizer 4.0 masters the complexities of controlling these large compressor networks.",
      },
      {
        title: "Energy recovery in car battery production",
        explain:
          "The extra heat can be used to warm buildings or to dry and age materials in manufacturing.Another option is selling the heat to surrounding industries or cities.This renewable energy could  heat houses or other industry processes in an energy- saving way.",
      },
      {
        title: "Onsite nitrogen generation for battery production",
        explain:
          "It is used in both the manufacturing of battery components and in the assembly of the battery cell.  The inert and pure properties of nitrogen prevent any contamination of the raw materials.",
      },
      // {
      //     title: "Laminating and testing of windshields",
      //     explain: "Compressed air is used to cut, transport, laminate and test the windshields for car manufacturers."
      // },
      // {
      //     title: "Wastewater Treatment",
      //     explain: "Compressed air is used to treat wastewater that is used during the production process in the automotive industry."
      // },
      // {
      //     title: "Electric car battery production",
      //     explain: "Complete compressed air and gas equipment for sustainably produced batteries for electrical cars at the lowest possible production cost."
      // },
    ],
    solutions:
      "Our compressed air and gas systems for the electric car battery production industry",
    subApplications: [
      {
        products: [
          {
          ...
          {
            name: "Desiccant air dryer range",
            img: "/images/industry/CD-BD-XD.png",
          },
          {
            name: "CO2 removal unit",
            img: "/images/industry/ad-co2-removal-unit.png",
          },
          {
            name: "Air filters",
            img: "/images/industry/filters_range_square-1.png",
          },
          {
            name: "Nitrogen Gas Generators",
            img: "/images/industry/Cover+NGP70+_2023_Max.png",
          },
          {
            name: "Energy recovery unit ER 90-900",
            img: "/images/industry/er650-ghost-pack-l-out-(2).jpeg",
          },
          {
            name: "Optimize your installation with air compressor control systems",
            img: "/images/industry/zr-90-160-vsd+-3d-setup---original-(3).png",
          },
          {
            name: "SMARTLINK - Air compressor monitoring system",
            img: "/images/industry/SMARTlink_visual_square_Hres.png",
          },
          {
            name: "AIRnet - Compressed air piping system",
            img: "/images/industry/AIRnet_family_Square.png",
          },
        ],
      },
    ],
  ...
  {
    id: 4,
    img: "/images/industry/Downpic.cc-1387721011.jpg",
    ...
    subApplications: [
      {
        ...
        products: [
          ...
          },
          {
            ...
            img: "/images/industry/CAM_002a_P.png",
          },
          {
            name: "ZS (VSD+) oil-free rotary screw blowers",
            img: "/images/industry/ZS+cam+004+portrait (1).png",
          },
          {
            name: "ZB VSD+ oil-free centrifugal air blowers",
            img: "/images/industry/k1925-01-atlas-copco-zb-turbogeblaese-installation-20x30.jpeg",
          },
          {
            name: "SF and SF+ oil-free scroll compressors",
            img: "/images/industry/new-banner-sf-hr.png",
          },
          {
            name: "AQ water-injected oil-free screw compressors",
            img: "/images/industry/aq30vsdff-ghost-out.jpeg",
          },
          {
            ...
            img: "/images/industry/zd-square.jpeg",
          },
        ],
      },
      {
        name: "Compressed gas solutions",
        products: [
          {
            name: "Reciprocating gas compressors HX & HN",
            img: "/images/industry/hxhn.png",
          ...
          {
            name: "CO2 compressor",
            img: "/images/industry/co2-gas-compressor-90-1110.png",
          },
        ],
      },
      {
        ...
        products: [
          {
            name: "NGM⁺ 7-70 nitrogen generator",
            img: "/images/industry/ngm70-pack-r.jpeg",
          },
          {
            name: "NGP⁺ PSA nitrogen generator",
            img: "/images/industry/ngp20plus-ghost-r-out.jpeg",
          },
        ],
      },
      {
        name: "Dryers and filter",
        products: [
          {
          ...
          },
          {
            ...
            img: "/images/industry/zh-xd+-installation-square.jpeg",
          },
          {
            name: "FD refrigerated air dryer",
            img: "/images/industry/-fd-005.jpeg",
          },
          {
            name: "DD(+) and PD(+) oil coalescing filters",
            img: "/images/industry/dd35plus-pd35plus-qd35plus-packr-out-b.tifff.jpeg",
          },
          {
            name: "Dust filtration for your air compressor",
            img: "/images/industry/dd35plus-pd35plus-qd35plus-packr-out-b.tifff.jpeg",
  ...
  {
    id: 5,
    img: "/images/industry/Downpic.cc-959296012.jpg",
    name: "General Industry",
    description:
      "Fully integrated and reliable high quality industrial air solutions. Lowest energy consumption rate even in the harshest environments.",
    applications: [
      {
        title: "Pneumatic Tools",
        explain:
          "Used to power drills, hammers, and wrenches in various industries.",
      },
      {
        title: "Material Handling",
        explain:
          "Assists in the movement and control of materials in manufacturing.",
      },
      {
        title: "Air Blow Guns",
        explain: "Used for cleaning and drying components and surfaces.",
      },
      {
        title: "Spray Painting",
        explain:
          "Provides a smooth and even coating in automotive and furniture industries.",
      },
      {
        title: "Air Brakes",
        explain:
          "Essential for the braking systems in heavy vehicles and machinery.",
      },
    ],
    subApplications: [
      {
        ...
        products: [
          {
            name: "Air compressor industrial solutions",
            img: "/images/industry/g-series-scroll-compressor.png",
          },
          {
            name: "Air dryers",
            img: "/images/industry/BD+850+Square.png",
          },
          {
            name: "Oil-free air blowers",
            img: "/images/industry/63_ZS_SETUP+-+cam+portrait+001.png",
          ...
          },
          {
            ...
            img: "/images/industry/DX+DN-1.png",
          },
          {
            name: "Process Gas and Air Equipment",
            img: "/images/industry/GT_Series_reliance_1600x1600.png",
          },
          {
            name: "Condensate treatment",
            img: "/images/industry/OSC-170_PackL.png",
          },
          {
            name: "Air receivers and aftercoolers",
            img: "/images/industry/AT3285-Monarch-Airlines-_2_.png",
          },
        ],
      },
    ],
  ...
  {
    id: 6,
    img: "/images/industry/Downpic.cc-1156760878.jpg",
    name: "Medical air and healthcare",
    description:
    ...
    applications: [
      {
        title: "Breathing Air",
        explain:
          "When supplying breathing air, Atlas Copco meets the highest requirements for reliability and purity. Our equipment offers protection against a range of contaminants that may be present in a compressed air fed breathing air system. Our innovative devices provide clean air for all your medical applications: Mechanical ventilation and anesthesia ,Drug delivery via a nebulizer  ,Testing and drying of medical devices",
      },
      {
        title: "Surgical Equipment",
        explain:
          "Puncture, dissect, drill? Numerous surgical instruments are operated with compressed air and are dried with compressed air after cleaning. Our equipment provides clean air for surgical applications such as:Pneumatic surgical tools (drilling, reaming, sawing, dissecting, tapping and screwing),Pneumatic ceiling pendant operation, Testing of medical devices, High- speed high torque motors, Drying instruments in Sterile Processing, Providing clean, dry air for endoscope sterilizers",
      },
      {
        title: "Complete Solutions",
        explain:
          "Our medical air compressors and dryers are specifically designed for medical application. They guarantee an uninterrupted air supply in every situation. Within the Atlas Copco group we have the possibilty to supply everything for your medical gas piped systems.Our BeaconMedaes brand offers complete medical air systems, vacuum systems, oxygen generators and gas cylinder manifold systems in your mechanical room, as well as the gas distribution system in your hospital.The BeaconMedaes organization covers all medical standards in the market and offers comprehensive technical and aftermarket support. ",
      },
    ],
    subApplications: [
      {
        name: "Fields of application for medical compressed air",
        products: [
          {
            name: "Breathing Air",
            img: "/images/industry/girl-5-years-lies-coma-hospital-ward-connected-life-support-equipment-monitors_484651-22269.jpg",
          },
          {
            name: "Surgical Equipment",
            img: "/images/industry/medical-technology-surgery-panorama_1036975-75238.jpg",
          },
          {
            name: "Complete Solutions",
            img: "/images/industry/doctor-showing-virtual-brain-her-hand_1134-641.jpg",
          },
        ],
      },
    ],
  ...
  {
    id: 7,
    img: "/images/industry/Downpic.cc-1372539594.jpg",
    name: "Pharmaceutical",
    description:
      "Compressed air solutions for all applications in the pharmaceutical industry. Read how we comply to the highest standards and needs of this industry.",
    applications: [
      {
        title: "Bottling/Canning/Packaging",
        explain:
      ...
      {
        title: "Manufacturing of tablets & capsules",
        explain:
      ...
      {
        title: "Manufacturing of ointments, creams, gels and syrups",
        explain:
      ...
      },
      {
        title: "Wastewater Treatment",
        explain:
          "The water that is used during the manufacturing process has to be treated first or it could contaminate the product. After using the water it has to be treated too before it can be reused or released.",
      },
    ],
    subApplications: [
      {
        name: "Compressors for pharmaceutical applications",
        products: [
          {
            name: "ZE&ZA (VSD) low pressure oil-free screw compressors",
            img: "/images/industry/ze-3-oem-screw-compressor.png",
          },
          {
            name: "Oil-free booster air compressor ZD (VSD)",
            img: "/images/industry/zd-square.jpeg",
      ...
      {
        name: "Dryers and nitrogen generators for pharmaceutical applications",
        products: [
          {
            name: "MDG & MD & ND rotary drum dryers",
            img: "/images/industry/MDG-square1.png",
          },
          {
            name: "BD+CD+XD+ twin tower desiccant air dryers",
            img: "/images/industry/zh-xd+-installation-square.jpeg",
      ...
      {
        name: "Filters for pharmaceutical applications",
        products: [
          {
            name: "Dust filtration for your air compressor",
            img: "/images/industry/dd145plus-pack.jpeg",
          ...
          {
            name: "High pressure filtration",
            img: "/images/industry/highpressurefilter50bar-p.jpeg",
          },
        ],
      },
      {
        name: "Ancillary products for pharmaceutical applications",
        products: [
          {
            name: "1630083300 : Roto Foodgrade Fluid",
            img: "/images/industry/ROTO-SYNTHETIC-FLUID-FOODGRADE-group5L20L.png",
          },
        ],
      },
    ],
  ...
  {
    id: 8,
    img: "/images/industry/Downpic.cc-498580447.jpg",
    ...
    subApplications: [
      {
        name: "Oil-free blower solutions for wastewater treatment",
        products: [
          {
            name: "ZS (VSD+) oil-free rotary screw blowers",
            img: "/images/industry/63-zs-setup---cam-001.png",
          },
          {
            name: "ZB VSD+ oil-free centrifugal air blowers",
            img: "/images/industry/k1925-01-atlas-copco-zb-turbogeblaese-installation-20x30.jpeg",
          ...
          {
            name: "ZM oil-free multistage centrifugal blowers and exhausters",
            img: "/images/industry/zm-hr-(4).png",
          },
          {
            name: "ZL (VSD) oil-free lobe blowers",
            img: "/images/industry/zl-cam-002-edited-d1.jpeg",
          },
        ],
      },
    ],
  ...
  {
    id: 9,
    img: "/images/industry/Downpic.cc-896359458.jpg",
    name: "Metal",
    description:
      "Clean and continuous compressed air supply for all applications in metal plants. Discover how we can help your metallurgy and metalworking plants.",
    applications: [
      {
      ...
      {
        title: "Heat treatment of metals with nitrogen",
        explain:
    ...
    subApplications: [
      {
        name: "Oil-free air compressors and blowers",
        products: [
          {
            name: "ZE&ZA (VSD) low pressure oil-free screw compressors",
            img: "/images/industry/ze-3-oem-screw-compressor.png",
      ...
      {
        name: "Gas compressors and generators",
        products: [
          {
            name: "Reciprocating gas compressors HX & HN",
            img: "/images/industry/hxhn.png",
          ...
          {
            name: "OGP 2-200 PSA oxygen generator",
            img: "/images/industry/ogp5-pack+front-1600x1600.png",
          },
          {
            name: "NGP⁺ PSA nitrogen generator",
            img: "/images/industry/ngp20plus-ghost-r-out.jpeg",
