      ...
      <div className="lg:container lg:max-w-9xl p-0 relative">
        ...
        <div className="lg:flex lg:items-center lg:justify-between lg:w-full ">
          ...
          <div className=" bg-[#ffff] shadow-2xl rounded-md lg:p-10 p-2 lg:relative lg:right-16">
            ...
            <a
              href="/about"
              className="lg:flex lg:items-center lg:justify-start flex items-center justify-center"
            >
              <button className="mt-5 bg-[#bf1e2e] p-2 text-white w-40 rounded-md flex items-center justify-center gap-2 font-semibold">
                View More
                <img
                  src="/images/flaticons/right.png"
                  alt=""
                  className="h-4 w-5"
                />
              </button>
