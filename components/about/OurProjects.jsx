...
const OurProjects = () => {
  return (
    <div className="flex items-center justify-between flex-col overflow-hidden container max-w-9xl mx-auto  mt-10 p-10">
      <div className="text-center m-10 ">
        <h6>Our Projects</h6>
        <h1>Embarking on Success</h1>
      </div>
      <div className="lg:flex lg:items-center gap-10 lg:justify-evenly sm:flex w-full lg:m-0 lg:mt-7">
        <Carousel
          opts={{
            align: "start",
            loop: true,
          ...
          className="w-full lg:max-w-2xl  mt-5"
        >
          <CarouselContent>
        ...
        <div className="flex flex-col   ">
          ...
          <p className="text-sm lg:text-base">
            ...
            the initial investment cost of the on-site installation, the service
            cost, and the energy cost. The NGP/NGM range has the lowest
            investment cost. However, with increasing running time, you are
            better advised to switch to the NGP+/NGM+ range to reduce energy
            costs,The generator separates air into component gases by passing
            inexpensive compressed air through semipermeable membranes
